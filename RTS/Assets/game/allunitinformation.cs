...
public class allunitinformation : MonoBehaviour {
	...
	public string unitTableURL= "https://xvee2zu0hf.execute-api.us-west-2.amazonaws.com/unitclass ";
...
//		copyallunitclass ();
	...
	void copyallunitclass(int i)
	{
        ...
        {
            gametmp.AddComponent<UnityEngine.AI.NavMeshObstacle>();
        }
        else
        {
            gametmp.AddComponent<UnityEngine.AI.NavMeshAgent>();
        }
